...
class UsageLog(Base):
    ...
    billing_quantity: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    billing_unit: Mapped[str] = mapped_column(String(32), default="", nullable=False)
    amount: Mapped[Decimal] = mapped_column(Numeric(18, 6), default=Decimal("0.000000"), nullable=False)
